...
/*
@Composable
fun UserGroupUi(viewModel: UserGroupViewModel, onBackClick: () -> Unit) {
    UserGroupScreen(onClick = onBackClick)
}

@Composable
fun UserGroupScreen(onClick: () -> Unit) {
    ...
    Column(
        ...
        HeaderUserGroup(onClick = onClick)
...
@Composable
fun HeaderUserGroup(onClick: () -> Unit) {
