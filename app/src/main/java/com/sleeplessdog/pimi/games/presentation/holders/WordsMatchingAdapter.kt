package com.sleeplessdog.pimi.games.presentation.holders
...
class WordsMatchingAdapter(
    ...
    private fun isError(word: Word): Boolean = errorWords.any { it === word }

    private fun isSelected(word: Word): Boolean = selectedWords.any { it === word }
