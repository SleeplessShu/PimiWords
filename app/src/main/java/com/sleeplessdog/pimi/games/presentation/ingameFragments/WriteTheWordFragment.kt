    ...
    private fun setupObservers() {
        ...
        childVM.ui.observe(viewLifecycleOwner) { ui ->
            ...
            binding.btnCheck.setBackgroundResource(
                if (ui.isCheckEnabled) R.drawable.bg_panoramic_view_correct_r_16
                else R.drawable.bg_panoramic_view_default_r_16
            )
            if (ui.isCheckCorrect) {
                ...
                binding.tvPrompt.setTextColor(
                    ContextCompat.getColor(
                        requireContext(), R.color.gray_05
                    )
                )
            } else {
                ...
                binding.tvPrompt.setTextColor(
                    ContextCompat.getColor(
                        requireContext(), R.color.dark_text_default
                    )
                )
