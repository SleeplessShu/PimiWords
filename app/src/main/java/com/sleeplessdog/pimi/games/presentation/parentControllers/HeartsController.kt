...
class HeartsController(
    ...
    private val staticHeartState: Map<Int, List<StaticHeartState>> = mapOf(
        3 to listOf(
            ...
            StaticHeartState.MEDIUM_ORANGE, StaticHeartState.MEDIUM_ORANGE, StaticHeartState.HIDDEN
        ), 1 to listOf(
            StaticHeartState.DARK_ORANGE, StaticHeartState.HIDDEN, StaticHeartState.HIDDEN
        ), 0 to listOf(
            StaticHeartState.HIDDEN, StaticHeartState.HIDDEN, StaticHeartState.HIDDEN
        )
    )
