...
class WordsController() {
    ...
    /*fun getWordForLanguage(entity: WordEntity, lang: Language): Word {
        ...
        return when (lang) {
            ...
            Language.SPANISH -> entity.spanish?.let {
                Word(
                    id,
                    it,
                    Language.SPANISH
            ...
            Language.RUSSIAN -> entity.russian?.let {
                Word(
                    id,
                    it,
                    Language.RUSSIAN
            ...
            Language.FRENCH -> entity.french?.let {
                Word(
                    id,
                    it,
                    Language.FRENCH
            ...
            Language.GERMAN -> entity.german?.let {
                Word(
                    id,
                    it,
                    Language.GERMAN
            ...
            Language.ARMENIAN -> entity.
            Language.SERBIAN -> TODO()
        }
    }
