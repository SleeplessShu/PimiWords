...
abstract class important_AppGroupsDictionary : RoomDatabase() {
    abstract fun wordCategoryDao(): WordCategoryDao

    companion object {
        fun build(context: Context): important_AppGroupsDictionary =
            Room.databaseBuilder(context, important_AppGroupsDictionary::class.java, "groups.db")
